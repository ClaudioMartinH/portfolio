  ...
  projects = [
    {
      titleKey: 'taskflow',
      category: 'web-dev',
      image: 'assets/img/taskflow.png',
      previewLink: 'https://taskflow.martinherranzc.es',
      detailsLink: 'https://github.com/ClaudioMartinH/taskflow',
      descriptionKey: 'appdev',
      textKey: 'taskflowtext',
    },
    {
      titleKey: 'itawiki',
      category: 'app-dev',
      image: 'assets/img/itawiki.png',
      previewLink: 'https://dev.itawiki.eurecatacademy.org/',
      detailsLink: 'https://github.com/IT-Academy-BCN/ita-wiki',
    ...
    },
    {
      ...
      previewLink: 'https://dicegame.martinherranzc.es/',
      detailsLink:
    ...
    },
    {
      ...
      previewLink: 'https://appactivitats.martinherranzc.es',
